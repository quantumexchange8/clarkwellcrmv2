        ...
        <nav class="flex " aria-label="Breadcrumb">
            <ol class="inline-flex items-center space-x-1 md:space-x-3 text-lg font-semibold">
                ...
                <div class="flex items-center">
                    ...
                    <p href="#" class="ml-1  text-gray-700 hover:text-orange-600 md:ml-2 dark:text-gray-400 dark:hover:text-white">Broker List</p>
                </div>
                </li>
            </ol>
        </nav>
        <div class="grid grid-cols-3 gap-6 my-4 max-[1100px]:grid-rows-auto max-[1450px]:grid-cols-2 max-[1100px]:grid-cols-1">
            ...
            <div class="max-w-sm bg-[#FDFCF3] border border-orange-200 rounded-lg shadow hover:shadow-2xl">
                <div class="flex flex-row items-center justify-center ml-6 mt-6 align-baseline shrink-0 grow-0">
                    <img class="w-24 h-24 mb-3 object-contain shrink-0 grow-0 rounded-full shadow-lg justify-center bg-orange-400" src="{{ asset('uploads/brokers/' .$broker->broker_image)}}" />
                ...
                <div class="p-5">
                    ...
                    <p href="#">
                        <h5 class="mb-2 text-lg font-bold tracking-tight text-orange-400 dark:text-white">Instructor Notes :</h5>
                    </p>
                    ...
                    <div class="relative bg-[#FDFCF3] rounded-lg shadow dark:bg-gray-700 p-2">
                        ...
                        <div class="p-6 space-y-2">
                            <div class="flex items-center space-x-4">
                                <img class="w-20 h-20 rounded-full bg-rose-400" src="{{ asset('uploads/brokers/' .$broker->broker_image)}}" alt="">
                            ...
                            <h5 class="text-lg font-bold tracking-tight text-orange-400 dark:text-white">Instructor Notes :</h5>
