                            ...
                            <ul role="list" class="divide-y divide-gray-200 dark:divide-gray-700">
                                <li class="py-3 sm:py-4">
                                    ...
                                    <div class="flex items-center space-x-4 text-sm">
                                        ...
                                        <div class="flex-1 min-w-0 text-left">
                                            <p class="text-orange-400 font-semibold truncate dark:text-white">
                                                @lang('public.personal_daily_withdrawal')
                                            </p>
                                        </div>
                                        <div class="inline-flex items-center font-semibold text-[#696057] dark:text-white">
                                            ${{number_format($user->userDailyMonthlyWithdrawal(), 2)}}
                                        </div>
                                    </div>
                                    <div class="flex items-center space-x-4 text-sm">
                                        <div class="flex-shrink-0">
                                        ...
                                        <div class="flex-1 min-w-0 text-left">
                                            <p class="text-orange-400 font-semibold truncate dark:text-white">
                                                @lang('public.personal_monthly_withdrawal')
                                            </p>
                                        </div>
                                        <div class="inline-flex items-center font-semibold text-[#696057] dark:text-white">
                                            ${{number_format($user->userDailyMonthlyWithdrawal(true), 2)}}
                                        </div>
                                    </div>
                                </li>
                                <li class="py-3 sm:py-4">
