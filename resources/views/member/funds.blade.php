        ...
        <nav class="flex mb-4" aria-label="Breadcrumb">
            <ol class="inline-flex items-center space-x-1 md:space-x-3 text-lg font-semibold">
                ...
                <div class="flex items-center">
                    ...
                    <p href="#" class="ml-1  text-gray-700 hover:text-orange-600 md:ml-2 dark:text-gray-400 dark:hover:text-white">Funds</p>
                </div>
                </li>
            </ol>
        </nav>
            ...
            <div class="col-span-4 px-4">
                ...
                <!-- Help text -->
                    <span class="text-sm text-gray-700 dark:text-gray-400">
                        @if(count($deposits) > 0)
                            Showing <span class="font-semibold text-gray-900 dark:text-white">{{$deposits->count()}}</span> to <span class="font-semibold text-gray-900 dark:text-white">{{ $deposits->count() }}</span> of <span class="font-semibold text-gray-900 dark:text-white">{{ $deposits->total() }}</span> Entries
                        @else
