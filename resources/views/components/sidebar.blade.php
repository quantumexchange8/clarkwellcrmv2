        ...
        <ul class="space-y-2">
            ...
            <li>
                <button type="button" class="flex items-center w-full p-2 text-base font-normal text-gray-900 transition duration-75 rounded-lg group hover:bg-orange-100 dark:text-white dark:hover:bg-gray-700" aria-controls="dropdown-profile" data-collapse-toggle="dropdown-profile">
                    ...
                    <span class="flex-1 ml-3 text-left whitespace-nowrap {{ request()->is('member/profile') || request()->is('member/verification') ? 'font-semibold text-lg text-orange-400' : 'font-semibold text-lg text-gray-500'}}" sidebar-toggle-item>@lang('public.profile')</span>
            ...
            <li>
                <button type="button" class="flex items-center w-full p-2 text-base font-normal text-gray-900 transition duration-75 rounded-lg group hover:bg-orange-100 dark:text-white dark:hover:bg-gray-700" aria-controls="dropdown-tree" data-collapse-toggle="dropdown-tree">
                    <svg class="h-8 w-8 {{ request()->is('member/commissions') || request()->is('member/network') || request()->is('member/tree') || request()->is('member/account/*') || request()->is('member/deposit/*') ? 'text-orange-400' : 'text-gray-500'}}"  width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">  <path stroke="none" d="M0 0h24v24H0z"/>  <line x1="3" y1="21" x2="21" y2="21" />  <line x1="3" y1="10" x2="21" y2="10" />  <polyline points="5 6 12 3 19 6" />  <line x1="4" y1="10" x2="4" y2="21" />  <line x1="20" y1="10" x2="20" y2="21" />  <line x1="8" y1="14" x2="8" y2="17" />  <line x1="12" y1="14" x2="12" y2="17" />  <line x1="16" y1="14" x2="16" y2="17" /></svg>
                    <span class="flex-1 ml-3 text-left whitespace-nowrap {{ request()->is('member/commissions') || request()->is('member/network') || request()->is('member/tree') || request()->is('member/account/*') || request()->is('member/deposit/*') ? 'font-semibold text-lg text-orange-400' : 'font-semibold text-lg text-gray-500'}}">@lang('public.network_plan')</span>
                    <svg sidebar-toggle-item class="w-6 h-6" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z" clip-rule="evenodd"></path></svg>
                </button>
                <ul id="dropdown-tree" class="{{ request()->is('member/tree') || request()->is('member/commissions') || request()->is('member/account/*') || request()->is('member/network') || request()->is('member/deposit/*') ? '' : 'hidden' }} py-2 space-y-2 font-semibold">
                    <li>
                    ...
                    <li>
                        <a href="{{ url('member/downline_listing') }}" class="{{ request()->is('member/downline_listing') ? 'text-sm font-semibold text-orange-400' : 'text-sm font-semibold text-gray-500'}} flex items-center w-full p-2 transition duration-75 rounded-lg pl-11 group hover:bg-orange-100 dark:text-white dark:hover:bg-gray-700 font-medium text-lg text-gray-500">Downline Listing</a>
                    </li>
                    <li>
