...
@foreach ($children as $child)
    @if (count($child->children))
        ...
        <div class="flex justify-start items-center w-full mb-4" id="childContainer">
            ...
            <a href="{{ url("member/account/$child->id") }}" class=" border border-gray-200 rounded-lg shadow-lg hover:shadow-2xl dark:bg-gray-800 w-full" id="childBg-{{ $count }}">
    ...
    @else
        <!-- Without Child -->
        <a href="{{ url("member/account/$child->id") }}" id="childContainer">
