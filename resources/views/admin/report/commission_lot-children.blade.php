...
@section('contents')
    ...
    <h1 class="font-semibold text-2xl text-gray-500">@lang('public.reports') / @lang('public.monthly_lot') - @lang('public.downline_listing')</h1>

    <!-- component -->
    <div class="flex flex-col">
        <form method="post" action="{{ route('lot_size_downline_listing') }}">
            @csrf
