    ...
    <div class="flex flex-col">
        <form method="post" action="{{ route('report_withdrawal_children') }}">
            ...
            <div class="grid gap-6 mb-6 mt-4 grid-cols-2 max-[1300px]:grid-cols-1 max-[1000px]:grid-cols-2 max-[770px]:grid-cols-1">
                ...
                <div>
                    <button type="submit" class="text-white bg-primary hover:bg-primary-600 border border-primary-200 focus:ring-4 focus:outline-none focus:ring-primary-600 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800 mb-2" name="submit" value="search">Search</button>
