...
<div id="downline_modal-{{ $record->id }}" tabindex="-1" aria-hidden="true" class="fixed top-0 left-0 right-0 z-50 hidden w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] md:h-full">
    <div class="relative w-full h-full max-w-2xl md:h-auto">
        <!-- Modal content -->
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            <button type="button" class="absolute top-3 right-2.5 text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-800 dark:hover:text-white" data-modal-hide="downline_modal-{{ $record->id }}">
                    ...
                    <div class="flex justify-center">
                        <div class="flex flex-col h-full">
                            ...
                            <div class="flex-grow p-3">
                                ...
                                <div class="mt-4 text-lg">
                                    <p class="font-medium text-gray-500 dark:text-gray-400 ">@lang('public.country'): <b>{{ $record->downline->getTranslatedCountry() }}</b></p>
                                </div>
                                <div class="mt-4 text-lg">
                                    <p class="font-medium text-gray-500 dark:text-gray-400 ">@lang('public.address'): <b>{{ $record->downline->address }}</b></p>
                                </div>
                            </div>
                        </div>
                    </div>
