...
@section('contents')
    ...
    <div class="flex flex-col">
        <form method="post" action="{{ route('report_deposits_children') }}">
            @csrf
            <div class="grid gap-6 mb-6 mt-4 grid-cols-3 max-[1600px]:grid-cols-2 max-[1100px]:grid-cols-1">
                ...
                <div class="max-[755px]:flex max-[755px]:flex-col gap-2">
                    ...
                    <button type="button" data-modal-target="withdrawModal" data-modal-toggle="withdrawModal" class="text-white bg-gray-400 hover:bg-gray-600 border border-gray-200 focus:ring-4 focus:outline-none focus:ring-blue-600 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">@lang('public.import')</button>
                ...
                @foreach($records as $record)
                    <tr class="border-b odd:bg-[#F6F6F6] even:bg-[#FDFCF3] text-sm">
                        ...
                        <td class="p-4 text-center">
                            <a href="javascript:void(0)" class="delete flex justify-center items-center"
        ...
        <div class="relative w-full h-full max-w-md md:h-auto">
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <div class="px-6 py-6 lg:px-8">
                    <form method="post" action="{{ route('import_deposit') }}" enctype="multipart/form-data">@csrf
                        <h3 class="mb-4 text-xl font-semibold inline-block text-orange-500 dark:text-white">@lang('public.import_deposits')</h3>
                        ...
                        <div class="flex items-center  mb-4 justify-center w-full">
                            <button type="submit" class="text-white bg-orange-400 hover:bg-orange-600 border border-orange-200 focus:ring-4 focus:outline-none focus:ring-blue-600 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" name="submit" value="import">@lang('public.import')</button>
                        </div>
        ...
        <div class="relative w-full h-full max-w-md md:h-auto">
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <div class="p-6 text-center">
                    <form method="POST" action="{{ route('deposit_delete') }}">
                        @csrf
                        <svg aria-hidden="true" class="mx-auto mb-4 text-gray-400 w-14 h-14 dark:text-gray-200" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
                        <div class="modal-body">
                            <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">@lang('public.delete_deposit_confirmation')</h3>
