            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <div class="px-6 py-6 lg:px-8">
                    <form method="post" action="{{ route('import_deposit') }}" enctype="multipart/form-data">@csrf
                        <h3 class="mb-4 text-xl font-semibold inline-block text-orange-500 dark:text-white">Import Deposit</h3>
                ...
                <div class="p-6 text-center">
                    <form method="POST" action="{{ route('deposit_delete') }}">
                        ...
                        <div class="modal-body">
                            <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">Are you sure you want to delete this deposit?</h3>
