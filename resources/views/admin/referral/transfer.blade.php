...
@section('contents')
    <h1 class="font-semibold text-2xl text-gray-500 mb-2">Referrals / {{ $title }}</h1>
    <p class="text-sm text-gray-400">Transfer customers to different networks.</p>
    @if($errors->any())
    ...
    <form class="mt-6" action="{{ route('referral_transfer') }}" method="post">
        ...
        <div class="flex gap-12">
            <div class="w-full max-w-sm p-4 bg-[#FDFCF3] border border-gray-200 rounded-lg shadow sm:p-6 dark:bg-gray-800 dark:border-gray-700 flex-1">
                ...
                <p class="text-sm font-normal text-gray-500 dark:text-gray-400">Search and choose the customer you want to transfer.</p>
                <div class="mt-6">
            ...
            <div class="w-full max-w-sm p-4 bg-[#FDFCF3] border border-gray-200 rounded-lg shadow sm:p-6 dark:bg-gray-800 dark:border-gray-700 flex-1">
                ...
                <p class="text-sm font-normal text-gray-500 dark:text-gray-400">Search and choose the customer you want to transfer to.</p>
                <div class="mt-6">
        ...
        <div class="mt-6">
            <button type="submit" class="text-white bg-[#40DD7F] hover:bg-success-400 focus:ring-4 focus:outline-none focus:ring-success-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-success-600 dark:hover:bg-success-700 dark:focus:ring-success-800">Confirm Transfer</button>
        </div>
    </form>
