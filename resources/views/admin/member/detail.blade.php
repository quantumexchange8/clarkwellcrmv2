...
@section('contents')
    ...
    <div class="flex flex-row gap-4 max-[1150px]:block">
        ...
        <a href="{{ route('member_edit', $user->id) }}" class="mt-2 bg-[#4DA5FF]  hover:bg-orange-600 border border-orange-200 focus:ring-4 focus:outline-none focus:ring-orange-600 font-semibold text-md text-gray-500 rounded-lg px-5 py-2.5 text-center inline-flex items-center ">
