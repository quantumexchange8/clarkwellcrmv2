...
@section('contents')
    <h1 class="font-semibold text-2xl text-gray-500">Members</h1>

    <!-- component -->
    <div class="flex flex-col">
        <form method="post" action="{{ route('member_listing') }}">
            @csrf
        ...
        <div class="relative overflow-x-auto shadow-md sm:rounded-lg mt-2 text-sm">
            <table class="w-full text-left">
                ...
                <tr>
                    ...
                    <th scope="col" class="p-4">
                        <div class="flex items-center">
                            @sortablelink('contact_number', 'Contact')
                            <a href="#"><svg xmlns="http://www.w3.org/2000/svg" class="w-3 h-3 ml-1" aria-hidden="true" fill="currentColor" viewBox="0 0 320 512"><path d="M27.66 224h264.7c24.6 0 36.89-29.78 19.54-47.12l-132.3-136.8c-5.406-5.406-12.47-8.107-19.53-8.107c-7.055 0-14.09 2.701-19.45 8.107L8.119 176.9C-9.229 194.2 3.055 224 27.66 224zM292.3 288H27.66c-24.6 0-36.89 29.77-19.54 47.12l132.5 136.8C145.9 477.3 152.1 480 160 480c7.053 0 14.12-2.703 19.53-8.109l132.3-136.8C329.2 317.8 316.9 288 292.3 288z"/></svg></a>
                        </div>
                    </th>
                    <th scope="col" class="p-4">
                ...
                <div class="p-6 text-center">
                    <form method="POST" action="{{ route('impersonate_user') }}">
                        ...
                        <div class="modal-body">
                            <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">Are you sure you want to impersonate into this user?</h3>
