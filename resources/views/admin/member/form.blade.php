...
@section('contents')
    ...
    <form method="post" action="{{ $submit }}" enctype="multipart/form-data">
        ...
        <div class="bg-[#FDFCF3] shadow-lg p-8">
            <h3 class="text-gray-500 font-bold text-xl mb-4">@lang('public.member_access')</h3>
            <div class="grid gap-6 mb-6 md:grid-cols-2">
                <div>
                    <label for="email" class="block mb-2 font-semibold text-md text-orange-400 dark:text-white">@lang('public.email_address')</label>
                ...
                <div>
                    <label for="rank" class="block mb-2 font-semibold text-md text-orange-400 dark:text-white">@lang('public.role')</label>
        ...
        <div class="bg-[#FDFCF3] shadow-lg p-8 mt-6">
            <h3 class="text-gray-500 font-bold text-xl mb-4">@lang('public.member_details')</h3>
            @if($title == 'Edit')
            ...
            <div class="grid gap-6 mb-6 md:grid-cols-2">
                ...
                <div>
                    <label for="rank" class="block mb-2 font-semibold text-md text-orange-400 dark:text-white">@lang('public.rank')</label>
                ...
                <div>
                    <label for="contact_number" class="block mb-2 font-semibold text-md text-orange-400 dark:text-white">@lang('public.contact')</label>
                ...
                <div>
                    <label for="countries" class="block mb-2 text-md font-semibold text-orange-400 dark:text-white">@lang('public.country')</label>
