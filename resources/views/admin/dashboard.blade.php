            ...
            <div class="px-6 py-4">
                <div class="flex items-center p-3">
                    ...
                    <div class="flex-col" style="margin-left: 20px">
                        ...
                        <h6 class="font-semibold text-md text-[#696057]">@lang('public.total_group_sales')</h6>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="px-6 py-4">
                <div class="flex items-center p-3">
                    ...
                    <div class="flex-col" style="margin-left: 20px">
                        ...
                        <h6 class="font-semibold text-md text-[#696057]">@lang('public.total_withdrawals')</h6>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="px-6 py-4">
                <div class="flex items-center p-3">
                    ...
                    <div class="flex-col" style="margin-left: 20px">
                        ...
                        <h6 class="font-semibold text-md text-[#696057]">@lang('public.total_commissions')</h6>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="px-6 py-4">
                <div class="flex items-center p-3">
                    ...
                    <div class="flex-col" style="margin-left: 20px">
                        ...
                        <h6 class="font-semibold text-md text-[#696057]">@lang('public.total_members')</h6>
                    </div>
                </div>
            </div>
        </div>
