...
@section('contents')
    ...
    <div class="flex max-[700px]:block">
        <h1 class="flex-1 font-semibold text-2xl text-gray-500">Dashboard</h1>
    </div>
            ...
            <div class="px-6 py-4">
                <div class="flex items-center p-3">
                    ...
                    <div class="flex-col" style="margin-left: 20px">
                        ...
                        <h6 class="font-semibold text-md text-gray-500">Total Group Sales</h6>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="px-6 py-4">
                <div class="flex items-center p-3">
                    ...
                    <div class="flex-col" style="margin-left: 20px">
                        ...
                        <h6 class="font-semibold text-md text-gray-500">Total Withdrawals</h6>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="px-6 py-4">
                <div class="flex items-center p-3">
                    ...
                    <div class="flex-col" style="margin-left: 20px">
                        ...
                        <h6 class="font-semibold text-md text-gray-500">Total Commissions</h6>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="px-6 py-4">
                <div class="flex items-center p-3">
                    ...
                    <div class="flex-col" style="margin-left: 20px">
                        ...
                        <h6 class="font-semibold text-md text-gray-500">Total Members</h6>
                    </div>
                </div>
            </div>
        </div>
        ...
        @foreach ($brokers as $broker)
                <h2 id="accordion-collapse-heading-{{$broker->id}}">
                    <button type="button" class="flex items-center justify-between w-full p-5 font-medium text-left text-gray-500 border border-b-0 border-gray-200 rounded-t-xl focus:ring-4 focus:ring-orange-200 dark:focus:ring-gray-800 dark:border-gray-700 dark:text-gray-400 bg-[#FDFCF3]" data-accordion-target="#accordion-collapse-body-{{$broker->id}}" aria-expanded="true" aria-controls="accordion-collapse-body-{{$broker->id}}">
                        <h5 class="font-bold text-lg ">{{$broker->name}}</h5>
