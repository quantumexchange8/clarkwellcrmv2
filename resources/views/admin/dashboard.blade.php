...
@section('contents')
    ...
    <div class="grid grid-cols-3 gap-8 mt-4 max-[1350px]:grid-rows-auto max-[1350px]:grid-cols-2 max-[950px]:grid-cols-1">
        <div class="max-w-sm rounded overflow-hidden shadow-lg text-white" style="background: #fd7f6f;">
            <div class="px-6 py-4">
        ...
        <div class="max-w-sm rounded overflow-hidden shadow-lg text-white" style="background: #7eb0d5;">
            <div class="px-6 py-4">
                <div class="flex items-center p-3">
        ...
        <div class="max-w-sm rounded overflow-hidden shadow-lg text-white" style="background: #b2e061;">
            <div class="px-6 py-4">
                <div class="flex items-center p-3">
        ...
        <div class="max-w-sm rounded overflow-hidden shadow-lg text-white" style="background: #bd7ebe;">
            <div class="px-6 py-4">
                <div class="flex items-center p-3">
        ...
        <div class="max-w-sm rounded overflow-hidden shadow-lg text-white" style="background: #ffb55a;">
            <div class="px-6 py-4">
                <div class="flex items-center p-3">
        ...
        <div class="max-w-sm rounded overflow-hidden shadow-lg text-white" style="background: #beb9db;">
            <div class="px-6 py-4">
                <div class="flex items-center p-3">
                    <svg class="h-12 w-12 text-white"  width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">  <path stroke="none" d="M0 0h24v24H0z"/>  <path d="M9 5H7a2 2 0 0 0 -2 2v12a2 2 0 0 0 2 2h10a2 2 0 0 0 2 -2V7a2 2 0 0 0 -2 -2h-2" />  <rect x="9" y="3" width="6" height="4" rx="2" />  <line x1="9" y1="12" x2="9.01" y2="12" />  <line x1="13" y1="12" x2="15" y2="12" />  <line x1="9" y1="16" x2="9.01" y2="16" />  <line x1="13" y1="16" x2="15" y2="16" /></svg>
                    <div class="flex-col" style="margin-left: 20px">
