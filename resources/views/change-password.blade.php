    ...
    <div class="block p-6 shadow-lg bg-[#FDFCF3] max-w-lg mx-auto">
        ...
        <form method="post" action="{{ url('member/change-password') }}">@csrf
            ...
            <p class="text-gray-800 mt-6 text-center">
                <a href="{{ url('member/dashboard')}}" class="text-orange-600 hover:text-orange-700 focus:text-orange-700 transition duration-200 ease-in-out underline">Back</a>
            </p>
        </form>
    </div>
@endsection
