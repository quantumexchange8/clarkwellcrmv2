...
@section('contents')
    <div class="w-full bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
        <div class="p-6 space-y-4 md:space-y-6 sm:p-8 bg-[#FDFCF3] rounded-lg">
            ...
            <h1 class="text-xl font-bold leading-tight tracking-tight md:text-2xl dark:text-white text-gray-900">Forgot Your Password?</h1>
            <form method="post" action="{{ url('forgot-password') }}">
                @csrf
                <div class="form-group mb-6">
                    <label for="exampleInputEmail2" class="form-label inline-block mb-2 text-orange-400 font-semibold">Insert email address here.</label>
                ...
                <button type="submit" class="save_btn w-full px-6 py-2.5 bg-orange-400 text-white font-medium text-sm leading-tight rounded shadow-md hover:bg-orange-700 hover:shadow-lg focus:bg-orange-400 focus:shadow-lg focus:outline-none focus:ring-0 transition duration-150 ease-in-out">Send Email</button>
